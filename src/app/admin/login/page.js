...
import { createClientComponentClient } from "@supabase/auth-helpers-nextjs"; // Import Supabase client for client-side
...
export default function LoginPage() {
  ...
  // Initialize Supabase client for client-side password reset functionality
  // This client uses NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY from your .env
  ...
  const handleResetPassword = async () => {
    ...
    const { error: resetError } = await supabase.auth.resetPasswordForEmail(email, {
      // Redirect back to the login page after the user clicks the reset link in their email
      // The current window.location.origin handles localhost or your deployed domain
